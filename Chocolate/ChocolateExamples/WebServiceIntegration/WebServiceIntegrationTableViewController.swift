...
public class WebServiceIntegrationTableViewController: UIViewController {
...
//        let webResource1 = webResource2<[SongModel]>(urlRequest: urlRequest1, parse: type(of: self).parseSongs)
...
//        let webResource2 = webResource1<[SongModel]>(urlRequest: urlRequest2, parse: type(of: self).parseSongs)
...
//            let songObjects = json["results"] as? [Object]
//            else { return nil }
//
//        var songs: [SongModel] = []
//
...
//                let artist = songObject["artistName"] as? String,
//                let name = songObject["trackName"] as? String
//                else { continue }
//
//            let song = SongModel(
